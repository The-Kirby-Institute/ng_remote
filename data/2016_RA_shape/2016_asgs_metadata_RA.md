...
For more information on the purpose and criteria used to develop these boundaries please refer to Australian Statistical Geography Standard (ASGS) Volume 5 – Remoteness Areas (cat no. 1270.0.55.005). This product contains several elements including the manual, region names and codes and the digital boundaries.
...
|-------|---------------------|-----------|--------|---------------------------|
|  1		| RA_CODE_2016        | Character | 4      | 2016 RA Full Code         |
|  2    | RA_NAME_2016        | Character | 50     | 2016 RA Name              |
|  3    | AREA_ALBERS_SQKM    | Float     | -      | Area (Albers) in sq/km    |

**ESRI Shape Files (.shp)**
| Count | Field      | Data Type | Length | Name                      |
|-------|------------|-----------|--------|---------------------------|
|  1    | RA_CODE16  | Character | 4      | 2016 RA Full Code         |
|  2    | RA_NAME16  | Character | 50     | 2016 RA Name              |
|  3    | AREASQKM16 | Float     | -      | Area (Albers) in sq/km    |
...
No further updates for these boundaries planned. The ASGS will be revised in 2021.
