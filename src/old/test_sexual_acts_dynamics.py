...
if make_graphs:
    ...
    yt, it, infections = ng.initilise_infection_trackers(n_steps)
...
for t in tqdm.tqdm(tt):
    ...
    if make_graphs:
        ...
        yt, it, infections = ng.update_infection_trackers(t - t0_sim, pop_parameters, meta, yt, it, infections)
...
if make_graphs:
    ...
    ng.make_infection_graphs(tt, yt, it, infections)
