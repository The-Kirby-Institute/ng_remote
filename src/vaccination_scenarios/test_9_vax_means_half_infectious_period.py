...
vax_parameters = {
    ...
    'vax_scenario': 'test_9_vax_means_half_infectious_period',  # Give the parameter set a name
    ...
    'effect': 3,                        # Sets vaccine effect - see numbered list above
    'site0_inf_mult': 0.5,                # Scaling of the infection probability (rectal)
    'site1_inf_mult': 0.5,                # Scaling of the infection probability (urethral)
    'site2_inf_mult': 0.5,                # Scaling of the infection probability (pharyngeal)
    'site0_trans_mult': 0.5,              # Scaling of the transmission probability (rectal)
    'site1_trans_mult': 0.5,              # Scaling of the transmission probability (urethral)
    'site2_trans_mult': 0.5,              # Scaling of the transmission probability (pharyngeal)
