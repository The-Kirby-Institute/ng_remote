...
THIS TEST SCRIPT
As with the previous test, but now vaccination makes infection impossible.
Expect to see transmission die out.
...
vax_parameters = {
    ...
    'vax_scenario': 'test_2_vax_means_no_infections',  # Give the parameter set a name
