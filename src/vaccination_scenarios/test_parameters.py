...
vax_parameters = {
    ...
    'vax_scenario': 'test_parameters',  # Give the parameter set a name
    'pop_scenario': int(2),             # Which population size to use? 1 (N=200), 2 (N=750), 3 (N=2200)
    'n_sims': 16,                       # Set the desired number of simulations to gather
    ...
    'deployment': 1,                    # Sets the deployment mode - see numbered list above
