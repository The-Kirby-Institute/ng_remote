...
vax_parameters = {
    ...
    'vax_scenario': 'test_17_vax_everyone',  # Give the parameter set a name
    ...
    'deployment': 3,                    # Sets the deployment mode - see numbered list above
    ...
    'prop_vax_0': 1,                  # Proportion of 16-19 year olds vaccinated
    'prop_vax_1': 1,                  # Proportion of 20-24 year olds vaccinated
    'prop_vax_2': 1,                  # Proportion of 25-29 year olds vaccinated
    'prop_vax_3': 1,                  # Proportion of over 30 year olds vaccinated
    'prop_vax_4': 1,                  # Proportion of over 30 year olds vaccinated
