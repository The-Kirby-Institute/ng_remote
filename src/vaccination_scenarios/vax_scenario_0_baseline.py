...
vax_parameters = {
    ...
    'n_sims': 5,                       # Set the desired number of simulations to gather
    ...
    'site0_inf_mult': 0.5,                # Scaling of the susceptibility (rectal)
    'site1_inf_mult': 0.5,                # Scaling of the susceptibility (urethral)
    'site2_inf_mult': 0.5,                # Scaling of the susceptibility (pharyngeal)
    ...
    'p_test_to_vax': 0.25,               # Proportion of people tested who get vaccinated
    'p_vax_16': 0.75,                   # Proportion of people vaccinated at sexual debut
    'prop_vax_0': 0.75,                  # Proportion of 16-19 year olds vaccinated
    'prop_vax_1': 0.2,                  # Proportion of 20-24 year olds vaccinated
    'prop_vax_2': 0.2,                  # Proportion of 25-29 year olds vaccinated
    'prop_vax_3': 0.2,                  # Proportion of over 30 year olds vaccinated
    'prop_vax_4': 0.2,                  # Proportion of over 30 year olds vaccinated
