...
THIS TEST SCRIPT
As with the previous test, but now vaccination makes infection half as likely.
Expect to see transmission die out a little but will come back.
...
vax_parameters = {
    ...
    'vax_scenario': 'test_3_vax_means_infection_half_as_likely',  # Give the parameter set a name
