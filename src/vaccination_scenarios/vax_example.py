...
vax_parameters = {
    ...
    'vax_scenario': 'vax_example',  # Give the parameter set a name
    ...
    'site0_inf_mult': 0.8,                # Scaling of the susceptibility (rectal)
    'site1_inf_mult': 0.8,                # Scaling of the susceptibility (urethral)
    'site2_inf_mult': 0.8,                # Scaling of the susceptibility (pharyngeal)
    'site0_trans_mult': 0.8,              # Scaling of the transmission probability (rectal)
    'site1_trans_mult': 0.8,              # Scaling of the transmission probability (urethral)
    'site2_trans_mult': 0.8,              # Scaling of the transmission probability (pharyngeal)
